...
res = ['EvoDAG','TF','TDOF','TDOF_params']
folderRes = ['/shared/mgraffg/evodag-used-datasets/binary-C/evodag-0.10.6/','../res/evodag-0.10.6/TF/','../res/evodag-0.10.6/TDOF/','../res/evodag-0.10.6/TDOF_params/']
folderData = '../data/'
